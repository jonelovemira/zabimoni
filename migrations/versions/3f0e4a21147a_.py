...
Revision ID: 3f0e4a21147a
Revises: 565b2b4d07a7
Create Date: 2015-02-13 08:55:50.890708

"""

# revision identifiers, used by Alembic.
revision = '3f0e4a21147a'
down_revision = '565b2b4d07a7'
...
def upgrade():
    ...
    op.add_column(u'trigger', sa.Column('metricname', sa.String(length=80), nullable=True))
...
def downgrade():
    ...
    op.drop_column(u'trigger', 'metricname')
