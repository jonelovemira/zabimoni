...
Revision ID: 34c3e7ee3f7d
Revises: 16c763503981
Create Date: 2015-05-05 06:03:57.986480

"""

# revision identifiers, used by Alembic.
revision = '34c3e7ee3f7d'
down_revision = '16c763503981'
...
def upgrade():
    ...
    op.add_column(u'itemtype', sa.Column('bcd_type', sa.Integer(), nullable=True))
    op.add_column(u'itemtype', sa.Column('condition', sa.String(length=64), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'itemtype', type_='foreignkey')
    op.drop_constraint(None, 'itemtype', type_='foreignkey')
    op.drop_column(u'itemtype', 'condition')
    op.drop_column(u'itemtype', 'bcd_type')
