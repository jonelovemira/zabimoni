...
Revision ID: 3bbb46196755
Revises: 3e9c39e7a487
Create Date: 2015-04-29 09:38:19.622355

"""

# revision identifiers, used by Alembic.
revision = '3bbb46196755'
down_revision = '3e9c39e7a487'
...
def upgrade():
    ...
    op.create_table('availablezone',
    sa.Column('availablezoneid', sa.BigInteger(), nullable=False),
    sa.Column('regionname', sa.String(length=128), nullable=True),
    sa.PrimaryKeyConstraint('availablezoneid')
    )
    ...
    op.add_column(u'billingrow', sa.Column('availablezone_id', sa.BigInteger(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'billingrow', type_='foreignkey')
    op.drop_constraint(None, 'billingrow', type_='foreignkey')
    op.drop_column(u'billingrow', 'availablezone_id')
