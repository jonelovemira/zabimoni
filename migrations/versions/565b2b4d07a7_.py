...
Revision ID: 565b2b4d07a7
Revises: 4ff86694db54
Create Date: 2015-02-13 07:31:34.313463

"""

# revision identifiers, used by Alembic.
revision = '565b2b4d07a7'
down_revision = '4ff86694db54'
...
def upgrade():
    ...
    op.add_column(u'attr', sa.Column('operation_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'attr', type_='foreignkey')
    op.drop_constraint(None, 'attr', type_='foreignkey')
    op.drop_column(u'attr', 'operation_id')
