...
Revision ID: 3a94b44a2e18
Revises: 31022732f1c8
Create Date: 2015-06-23 09:36:27.170030

"""

# revision identifiers, used by Alembic.
revision = '3a94b44a2e18'
down_revision = '31022732f1c8'
...
def upgrade():
    ...
    op.create_table('intervaldata',
    sa.Column('intervaldataid', sa.Integer(), nullable=False),
    sa.Column('timefrom', sa.BigInteger(), nullable=False),
    sa.Column('timeto', sa.BigInteger(), nullable=False),
    sa.Column('groupname', sa.String(length=128), nullable=False),
    sa.Column('itemkey', sa.String(length=128), nullable=False),
    sa.Column('displayname', sa.String(length=128), nullable=True),
    sa.Column('sumv', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('intervaldataid')
    )
