...
Revision ID: 16c763503981
Revises: 80966af8b72
Create Date: 2015-05-04 01:42:07.105222

"""

# revision identifiers, used by Alembic.
revision = '16c763503981'
down_revision = '80966af8b72'
...
def upgrade():
    ...
    op.add_column(u'billingrow', sa.Column('billingtime_id', sa.BigInteger(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'billingrow', type_='foreignkey')
    op.drop_constraint(None, 'billingrow', type_='foreignkey')
    op.drop_column(u'billingrow', 'billingtime_id')
