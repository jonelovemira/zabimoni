...
Revision ID: 5943ea305bbe
Revises: 3a94b44a2e18
Create Date: 2015-06-24 02:56:33.752313

"""

# revision identifiers, used by Alembic.
revision = '5943ea305bbe'
down_revision = '3a94b44a2e18'
...
def upgrade():
    ...
    op.create_table('odmonth',
    sa.Column('odmonthid', sa.Integer(), nullable=False),
    sa.Column('beginclock', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('odmonthid'),
    sa.UniqueConstraint('beginclock')
    )
    ...
    op.add_column(u'intervaldata', sa.Column('odmonth_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column(u'intervaldata', 'odmonth_id')
