...
Revision ID: 5146fb0af25d
Revises: 23469cca32b2
Create Date: 2015-01-14 06:56:32.715473

"""

# revision identifiers, used by Alembic.
revision = '5146fb0af25d'
down_revision = '23469cca32b2'
...
def upgrade():
    ...
    op.drop_column(u'user', 'loginpermission')
...
def downgrade():
    ...
    op.drop_constraint(None, 'window', type_='foreignkey')
    op.add_column(u'user', sa.Column('loginpermission', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.add_column(u'user', sa.Column('pw_hash', mysql.VARCHAR(collation=u'utf8_bin', length=200), nullable=True))
