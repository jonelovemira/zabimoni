...
Revision ID: 37d3b9a97e7c
Revises: 3e7b8e2ea504
Create Date: 2015-04-20 09:09:11.080642

"""

# revision identifiers, used by Alembic.
revision = '37d3b9a97e7c'
down_revision = '3e7b8e2ea504'
...
def upgrade():
    ...
    op.add_column(u'itemtype', sa.Column('description', sa.String(length=256), nullable=True))
    op.drop_constraint(u'itemkey', 'itemtype', type_='unique')
    # op.drop_index('itemkey', table_name='itemtype')
    op.drop_constraint(u'itemtypename', 'itemtype', type_='unique')
    # op.drop_index('itemtypename', table_name='itemtype')
...
def downgrade():
    ...
    op.drop_constraint(None, 'itemtype', type_='foreignkey')
    op.drop_constraint(None, 'itemtype', type_='foreignkey')
    # op.create_index('itemtypename', 'itemtype', ['itemtypename'], unique=True)
    op.create_unique_constraint(u'itemtypename', 'itemtype', ['itemtypename'])
    # op.create_index('itemkey', 'itemtype', ['itemkey'], unique=True)
    op.create_unique_constraint(u'itemkey', 'itemtype', ['itemkey'])
    op.drop_column(u'itemtype', 'description')
