...
Revision ID: 32dfad52b281
Revises: 538a5fc30e2a
Create Date: 2015-02-10 01:04:57.184053

"""

# revision identifiers, used by Alembic.
revision = '32dfad52b281'
down_revision = '538a5fc30e2a'
...
def upgrade():
    ...
    op.add_column(u'selectedmetrics', sa.Column('report_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'selectedmetrics', type_='foreignkey')
    op.drop_column(u'selectedmetrics', 'report_id')
